...
Produces 5 figures into results/presentations/KIAT_CREFLE_UPDATE_MARCH2026/ using sample_09 (set=035):
...
OUTPUT_DIR = PROJECT_ROOT / "results" / "presentations" / "KIAT_CREFLE_UPDATE_MARCH2026"
